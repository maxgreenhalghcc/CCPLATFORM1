...
export default function HomePage() {
  return (
    <div className="flex min-h-screen flex-col">
      <MainNav />
      <main className="cc-page cc-page-section flex flex-1 flex-col items-center justify-center gap-8 text-center">
        <span className="cc-chip bg-muted text-muted-foreground font-semibold uppercase tracking-wider">
